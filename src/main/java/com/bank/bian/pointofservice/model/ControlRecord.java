package com.bank.bian.pointofservice.model;
...
/**
 * The BIAN control record for this service domain: "POS Session Operating Session".
 *
 ...
 * to its asset type (POS Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "POS Session Operating Session";
